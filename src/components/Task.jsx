...
<div className="rounded-2 w-full bg-sky-50 p-4">
   <div className=" mb-3 px-6 text-gray-900 text-sm gap-72 flex">
   <div className="mb-3 gap-9 flex">
              ...
              <h1 className={`flex animate-pulse  cursor-pointer ${activeSection === "Lists" ? "text-blue-600 font-bold" : ""}`} onClick={() => setActiveSection("Lists")}>
...
{activeSection === "Lists" && (
              <div className="bg-white p-2  min-w-full min-h-screen rounded-lg">
