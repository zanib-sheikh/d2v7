...
<div className="flex flex-wrap md:flex-nowrap md:space-x-4 mt-4 max-w-[90%] mx-auto text-lg text-white mb-1 justify-center">
  {[
    { color: "bg-[#FFDE59]", icon: <BadgeCheck className="w-4 h-4 text-white" />, title: "Draft" },
    ...
    <div key={index} className={`flex flex-col ${color} rounded-lg border 
      ...
      md:px-4 px-2 justify-center mb-6 transition-all duration-300`}>
...
<div className="bg-white p-4 w-full h-full mt-3 rounded-lg shadow-md">
  {/* Navigation Tabs */}
