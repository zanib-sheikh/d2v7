...
<section id="dashboard" className="w-4/5 px-2 inline-block  items-center justify-center">
<div className="flex relative  gap-0 md:space-x-1 max-w-3xl mt-16 text-lg   pl-2 pr-2 text-white mb-1 ">
      <div className="flex flex-col bg-[#71C1E8] rounded-lg border w-[500px] h-[120px] py-1 px-4 justify-center">
...
<div className="flex flex-col bg-[#FFDE59] rounded-lg border w-[500px] h-[120px] md:p-4 p-4 justify-center md:mt-0 mt-4">
  <div className="flex items-center space-x-4">
...
<div className="flex flex-col bg-[#FFA0A3] rounded-lg border w-[500px] h-[120px] md:p-4 p-4 justify-center md:mt-0 mt-4">
...
<div className="flex flex-col bg-[#01B574C4] rounded-lg border w-[500px] h-[120px] md:p-4 p-4 justify-center md:mt-0 mt-4">
  <div className="flex items-center space-x-6">
...
<div className="mt-0 px-2">
 ...
 {/* box 4 */}
      ...
      <section id="calendar" className="w-full inline-block mt-8 items-start justify-start">
